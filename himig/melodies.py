...
twinkle_twinkle = [
    ...
    "G4:1.0", "G4:1.0", "F4:1.0", "F4:1.0", "E4:1.0", "E4:1.0", "D4:2.0",
    "C4:1.0", "C4:1.0", "G4:1.0", "G4:1.0", "A4:1.0", "A4:1.0", "G4:2.0",
    "F4:1.0", "F4:1.0", "E4:1.0", "E4:1.0", "D4:1.0", "D4:1.0", "C4:3.0"
]
...
ode_to_joy = [
    ...
    "E4:1.0", "D4:1.0",
    "D4:1.0", "E4:0.5", "E4:0.5", "F4:0.5", "G4:0.5",
    "G4:0.5", "F4:0.5", "E4:0.5", "D4:0.5",
    "C4:0.5", "C4:0.5", "D4:0.5", "E4:0.5",
    "D4:1.0", "C4:1.0"
]
...
# Für Elise
fur_elise = [
    "E5:0.5", "D#5:0.5", "E5:0.5", "D#5:0.5", "E5:0.5", "B4:0.5", "D5:0.5", "C5:0.5", "A4:1.0",
    "R:0.5",
